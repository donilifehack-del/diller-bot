...
def main():
    ...
    order_conv = ConversationHandler(
        ...
        states={
            ...
            3: [MessageHandler(filters.TEXT & ~filters.COMMAND, orders_handler.order_enter_qty)],
            4: [
                CallbackQueryHandler(orders_handler.order_discount_type, pattern="^disc_"),
                MessageHandler(filters.TEXT & ~filters.COMMAND, orders_handler.order_discount_value),
            ],
            5: [MessageHandler(filters.TEXT & ~filters.COMMAND, orders_handler.order_enter_paid)],
            6: [MessageHandler(filters.TEXT & ~filters.COMMAND, orders_handler.order_enter_note)],
            7: [
                CallbackQueryHandler(orders_handler.order_save, pattern="^ord_save$"),
